      ...
      <div class="content">
        ...
        >
          <template #header-left>
            <div type="button" class="agent-nav-btn compact" @click="toggleConf">
              <Settings2 size="16" class="nav-btn-icon"/>
            </div>
            <div v-if="selectedAgentId" ref="moreButtonRef" type="button" class="agent-nav-btn compact" @click="toggleMoreMenu">
              <Ellipsis size="16" class="nav-btn-icon"/>
            </div>
          </template>
        </AgentChatComponent>
      </div>
