...
from src.agents.common.tools import get_kb_based_tools, make_knowledge_graph_tool
...
class ChatbotAgent(BaseAgent):
    ...
    async def get_tools(self, tools: list[str] = None, mcps=None, knowledges=None):
        ...
        # 如果配置了知识库，则将“查询知识图谱”工具替换为绑定范围版本
        if knowledges:
            try:
